...
<body>
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-lg sticky-top bg-dark navbar-dark">
      ...
      <div class="container-fluid">
        ...
        <a class="navbar-brand" href="home"><i class="fas fa-plane"></i>Travel with me</a>
  ...
  <footer>
    <ul class="sci">
      <li><a href="#"><img src="app/img/facebook.png" alt="Facebook"></a></li>
      <li><a href="#"><img src="app/img/instagram.png" alt="Instagram"></a></li>
      <li><a href="#"><img src="app/img/twitter.png" alt="Twitter"></a></li>
    </ul>
